...
const LORE = [
  { year: "1453", event: "Conquête de Constantinople" },
  { year: "1520", event: "Suleiman le Magnifique" },
  { year: "1556", event: "Akbar l'Inde moghole" },
  { year: "1588", event: "Shah Abbas & Isfahan" },
  { year: "1492", event: "Askia Muhammad Songhaï" },
];

export default function Ere4Page() {
  ...
  const era3Cond       = ERA_CONDITIONS.find(e => e.eraIndex === 4)!;
    ...
    <div className="flex flex-col min-h-screen" style={{ background: THEME.bg }}>
      ...
      <div className="sticky top-0 z-20 flex items-center gap-3 px-4 pt-4 pb-3"
        ...
        <div className="flex-1">
          ...
          <h1 className="text-base font-black" style={{ color: THEME.accent, fontFamily: "var(--font-bricolage)" }}>Les Empires</h1>
        </div>
