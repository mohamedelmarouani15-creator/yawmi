...
const ERE5_ORDER = ["al_azhar_v","sarajevo","kuala_lumpur"];

const THEME = { bg: "linear-gradient(180deg,#020a05 0%,#1a0a04 100%)", accent: "#FFD700" };

const LORE = [
  { year: "970",  event: "Fondation d'Al-Azhar" },
  { year: "1992", event: "Siège de Sarajevo" },
  { year: "2000", event: "Islam en Asie du Sud-Est" },
  { year: "XXIe", event: "Finance islamique mondiale" },
  { year: "2024", event: "1,8 milliard de musulmans" },
];

export default function Ere5Page() {
  ...
  const era3Cond       = ERA_CONDITIONS.find(e => e.eraIndex === 5)!;
    ...
    <div className="flex flex-col min-h-screen" style={{ background: THEME.bg }}>
      ...
      <div className="sticky top-0 z-20 flex items-center gap-3 px-4 pt-4 pb-3"
        ...
        <div className="flex-1">
          <p className="text-[9px] uppercase tracking-widest opacity-40" style={{ color: "var(--text)", fontFamily: "var(--font-dm-sans)" }}></p>
          <h1 className="text-base font-black" style={{ color: THEME.accent, fontFamily: "var(--font-bricolage)" }}>La Maîtrise</h1>
        </div>
      ...
      {!eraUnlocked && (
        <div className="flex flex-col items-center justify-center flex-1 px-8 text-center gap-5 py-16">
          ...
          <div>
            <h2 className="text-xl font-black mb-2" style={{ color: "var(--text)", fontFamily: "var(--font-bricolage)" }}> verrouillée</h2>
            <p className="text-sm opacity-50 mb-4" style={{ color: "var(--text)", fontFamily: "var(--font-dm-sans)" }}>
              Complète l&apos;Ère III et monte en niveau
            </p>
            {[
        ...
        <div className="flex flex-col px-4 py-4 gap-5">
          ...
          <div className="text-center pb-6">
            <p className="text-xs opacity-25" style={{ color: "var(--text)", fontFamily: "var(--font-dm-sans)" }}>
              Ère V — La Maîtrise · Niv. 50 + 6 arcs + maîtrise 70%
            </p>
          </div>
        </div>
      )}
