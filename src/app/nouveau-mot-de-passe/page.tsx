    ...
    <main className="relative flex min-h-screen flex-col items-center justify-center bg-[#061A12] px-6">
      ...
      <div className="relative z-10 w-full max-w-sm">
        <div className="mb-8 text-center">
          <h1 className="text-4xl font-extrabold" style={{ color: "var(--text)", fontFamily: "var(--font-bricolage)" }}>Yawmi</h1>
          <p className="mt-1 text-xl" style={{ color: "var(--gold)", fontFamily: "var(--font-amiri)" }}>يومي</p>
        </div>

        {done ? (
          <div className="flex flex-col items-center gap-4 text-center">
            <CheckCircle2 size={48} style={{ color: "var(--gold)" }} />
            <p className="text-lg font-bold" style={{ color: "var(--text)", fontFamily: "var(--font-bricolage)" }}>
