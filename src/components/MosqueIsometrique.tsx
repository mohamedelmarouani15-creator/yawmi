...
function Stage1() {
  return (
    <g>
      ...
      {/* Tapis */}
      <rect x="100" y="175" width="120" height="80" rx="8" fill="var(--primary)" opacity="0.7" transform="skewX(-8)" />
      <rect x="108" y="183" width="104" height="64" rx="5" fill="#044F36" opacity="0.5" transform="skewX(-8)" />
      {/* Motif tapis */}
      <rect x="140" y="195" width="40" height="40" rx="3" fill="none" stroke="var(--gold)" strokeWidth="1" opacity="0.5" transform="skewX(-8)" />
      {/* Mihrab */}
      <rect x="145" y="140" width="30" height="45" rx="2" fill="#044F36" />
      <path d="M145,155 Q160,135 175,155" fill="#033D2A" />
      <path d="M148,158 Q160,140 172,158" fill="none" stroke="var(--gold)" strokeWidth="1" opacity="0.7" />
      {/* Arche mihrab */}
      <rect x="150" y="158" width="20" height="27" rx="1" fill="#033D2A" />
      {/* Dôme naissant */}
      <ellipse cx="160" cy="140" rx="16" ry="8" fill="var(--primary)" opacity="0.8" />
      <ellipse cx="160" cy="136" rx="12" ry="6" fill="#066B49" opacity="0.9" />
      {/* Croissant */}
      <text x="155" y="130" fontSize="10" fill="var(--gold)" opacity="0.8">☽</text>
      {/* Calligraphie */}
      <text x="160" y="200" textAnchor="middle" fontSize="11"
        style={{ fontFamily: "serif" }} fill="var(--gold)" opacity="0.4">الله</text>
    </g>
  );
}
...
function Stage2() {
  return (
    <g>
      ...
      {/* Toit plat */}
      <rect x="78" y="148" width="164" height="12" rx="2" fill="var(--primary)" />
      {/* Arches (3 portiques) */}
      {[105, 145, 185].map((x, i) => (
        <g key={i}>
      ...
      {/* Dôme principal */}
      <ellipse cx="160" cy="152" rx="35" ry="14" fill="var(--primary)" />
      ...
      {/* Lanterne dôme */}
      <rect x="156" y="114" width="8" height="10" rx="2" fill="var(--primary)" />
      <line x1="160" y1="108" x2="160" y2="114" stroke="var(--gold)" strokeWidth="1.5" />
      <text x="156" y="108" fontSize="9" fill="var(--gold)">☽</text>
      {/* Minaret gauche */}
      <rect x="82" y="100" width="18" height="60" rx="2" fill="#044F36" />
      <ellipse cx="91" cy="100" rx="9" ry="5" fill="var(--primary)" />
      <ellipse cx="91" cy="95" rx="6" ry="10" fill="#066B49" />
      <line x1="91" y1="86" x2="91" y2="92" stroke="var(--gold)" strokeWidth="1" />
      <text x="87" y="86" fontSize="7" fill="var(--gold)">☽</text>
      {/* Fenêtres */}
      {[110, 150, 190].map((x, i) => (
        <rect key={i} x={x} y="160" width="12" height="16" rx="3" fill="var(--gold)" opacity="0.15" />
      ))}
      {/* Étoiles */}
      {[[100, 250], [220, 245], [130, 260], [195, 255]].map(([cx, cy], i) => (
        <circle key={i} cx={cx} cy={cy} r="2" fill="var(--gold)" opacity="0.3" />
      ))}
    </g>
  );
}
...
function Stage3() {
  return (
    <g>
      ...
      {/* Toit */}
      <rect x="73" y="150" width="174" height="13" rx="3" fill="var(--primary)" />
      {/* Bandeau décoratif */}
      <rect x="73" y="148" width="174" height="4" rx="1" fill="var(--gold)" opacity="0.4" />
      {/* Arches (5 portiques) */}
      ...
      {/* Dôme central */}
      <ellipse cx="160" cy="153" rx="38" ry="13" fill="var(--primary)" />
      ...
      <rect x="157" y="104" width="6" height="8" rx="1.5" fill="var(--primary)" />
      <line x1="160" y1="96" x2="160" y2="104" stroke="var(--gold)" strokeWidth="1.5" />
      <text x="155.5" y="96" fontSize="9" fill="var(--gold)">☽</text>
      {/* Petits dômes latéraux */}
      {[105, 215].map((cx, i) => (
        <g key={i}>
          <ellipse cx={cx} cy="153" rx="18" ry="7" fill="var(--primary)" />
          <ellipse cx={cx} cy="146" rx="14" ry="10" fill="#066B49" />
          <ellipse cx={cx} cy="138" rx="9" ry="7" fill="#077A52" />
          <line x1={cx} y1="130" x2={cx} y2="136" stroke="var(--gold)" strokeWidth="1" />
          <text x={cx - 4} y="130" fontSize="7" fill="var(--gold)">☽</text>
        </g>
      ))}
      {/* Minaret gauche */}
      <rect x="76" y="88" width="20" height="68" rx="2" fill="#044F36" />
      <rect x="74" y="148" width="24" height="8" rx="1" fill="var(--primary)" />
      <rect x="74" y="118" width="24" height="6" rx="1" fill="var(--primary)" opacity="0.7" />
      <ellipse cx="86" cy="88" rx="10" ry="5" fill="var(--primary)" />
      <ellipse cx="86" cy="82" rx="7" ry="11" fill="#066B49" />
      <line x1="86" y1="72" x2="86" y2="78" stroke="var(--gold)" strokeWidth="1.5" />
      <text x="82" y="72" fontSize="8" fill="var(--gold)">☽</text>
      {/* Minaret droit */}
      <rect x="224" y="88" width="20" height="68" rx="2" fill="#044F36" />
      <rect x="222" y="148" width="24" height="8" rx="1" fill="var(--primary)" />
      <rect x="222" y="118" width="24" height="6" rx="1" fill="var(--primary)" opacity="0.7" />
      <ellipse cx="234" cy="88" rx="10" ry="5" fill="var(--primary)" />
      <ellipse cx="234" cy="82" rx="7" ry="11" fill="#066B49" />
      <line x1="234" y1="72" x2="234" y2="78" stroke="var(--gold)" strokeWidth="1.5" />
      <text x="230" y="72" fontSize="8" fill="var(--gold)">☽</text>
      {/* Fontaine */}
      <ellipse cx="160" cy="254" rx="22" ry="10" fill="rgba(5,92,63,0.3)" stroke="var(--gold)" strokeWidth="0.5" strokeOpacity="0.3" />
      <ellipse cx="160" cy="250" rx="14" ry="6" fill="rgba(5,150,100,0.2)" />
      <ellipse cx="160" cy="247" rx="7" ry="4" fill="rgba(5,180,120,0.25)" />
      <rect x="158" y="236" width="4" height="12" rx="1" fill="var(--primary)" opacity="0.6" />
      {/* Palmiers */}
      <line x1="102" y1="252" x2="104" y2="220" stroke="#044F36" strokeWidth="2.5" />
      <ellipse cx="104" cy="218" rx="10" ry="6" fill="var(--primary)" opacity="0.7" />
      <line x1="216" y1="252" x2="218" y2="222" stroke="#044F36" strokeWidth="2.5" />
      <ellipse cx="218" cy="220" rx="10" ry="6" fill="var(--primary)" opacity="0.7" />
      {/* Fenêtres dorées */}
      {[88, 120, 152, 184].map((x, i) => (
        <g key={i}>
          <rect x={x} y="162" width="14" height="18" rx="3" fill="var(--gold)" opacity="0.12" stroke="var(--gold)" strokeWidth="0.5" strokeOpacity="0.3" />
          <path d={`M${x},168 Q${x+7},161 ${x+14},168`} fill="var(--gold)" opacity="0.1" />
        </g>
      ))}
      {/* Lanternes */}
      {[[135, 237], [185, 237]].map(([x, y], i) => (
        <g key={i}>
          <circle cx={x} cy={y} r="4" fill="var(--gold)" opacity="0.25" />
          <circle cx={x} cy={y} r="2" fill="var(--gold)" opacity="0.5" />
        </g>
      ))}
    </g>
  );
    ...
    <div className={className}>
      <div className="relative">
        ...
        <svg viewBox="0 0 320 300" width="100%" style={{ maxHeight: 260 }}>
          ...
          {stage === 3 && [[60, 100], [260, 110], [80, 180], [250, 175]].map(([cx, cy], i) => (
            <motion.circle key={i} cx={cx} cy={cy} r="2" fill="var(--gold)"
      ...
      <div className="px-1 mt-1">
        <div className="flex items-center justify-between mb-1.5">
          <p className="text-sm font-semibold" style={{ color: "var(--text)", fontFamily: "var(--font-bricolage)" }}>
            {stageLabels[stage]}
          </p>
          <p className="text-xs" style={{ color: "var(--gold)", fontFamily: "var(--font-dm-sans)" }}>
            {streak}j de streak
          </p>
        </div>
        {nextStageStreaks && (
        ...
        {!nextStageStreaks && (
          <p className="text-xs opacity-40 mt-1" style={{ color: "var(--gold)", fontFamily: "var(--font-dm-sans)" }}>
