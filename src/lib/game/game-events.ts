...
export const GAME_EVENTS: Record<GameEventId, GameEvent> = {
  ...
  aid_fitr: {
    ...
    emoji: "🎉",
    theme: { primaryColor: "#D4AF37", accentColor: "#FFD700", bgOverlay: "rgba(212,175,55,0.1)" },
  ...
  mawlid: {
    ...
    emoji: "🕌",
    theme: { primaryColor: "#D4AF37", accentColor: "#F5DEB3", bgOverlay: "rgba(212,175,55,0.08)" },
  ...
  joumaa: {
    ...
    nameAr: "يوم الجمعة",
    emoji: "🕌",
    theme: { primaryColor: "#055C3F", accentColor: "#4ade80", bgOverlay: "rgba(5,92,63,0.08)" },
