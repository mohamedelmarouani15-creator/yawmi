...
export const QUESTIONS: Question[] = [
  ...
  // ── SIRA — Vie du Prophète ﷺ ────────────────────────────────────────
  {
    id: "sira_001", category: "sira", type: "mcq", difficulty: 1,
    arabicRequired: "none",
    question: "Quelle était la profession du Prophète Muhammad ﷺ avant la révélation ?",
    options: [
      { text: "Agriculteur", correct: false },
      { text: "Marchand", correct: true },
      { text: "Soldat", correct: false },
      { text: "Pêcheur", correct: false },
    ],
    explanation: "Le Prophète ﷺ était marchand, connu pour son honnêteté. Il était surnommé Al-Amin (le digne de confiance) bien avant la révélation.",
    culturalCapsule: { title: "Al-Amin — le digne de confiance", text: "Les Mecquois, pourtant adversaires de l'islam, continuaient à confier leurs dépôts au Prophète ﷺ même après sa mission. Le jour de la Hijra, il chargea Ali رضي الله عنه de remettre ces dépôts à leurs propriétaires." },
  },
  {
    id: "sira_002", category: "sira", type: "mcq", difficulty: 1,
    arabicRequired: "none",
    ...
    explanation: "Le Prophète ﷺ est né à La Mecque, dans le quartier de Banu Hashim, vers l'an 570 de l'ère chrétienne — l'Année de l'Éléphant.",
  },
  {
    id: "sira_003", category: "sira", type: "mcq", difficulty: 1,
    arabicRequired: "none",
    question: "Comment s'appelait la première épouse du Prophète ﷺ ?",
    options: [
      { text: "Aïcha رضي الله عنها", correct: false },
      { text: "Khadija رضي الله عنها", correct: true },
      { text: "Hafsa رضي الله عنها", correct: false },
      { text: "Fatima رضي الله عنها", correct: false },
    ],
    explanation: "Khadija رضي الله عنها fut la première épouse du Prophète ﷺ. Riche commerçante, elle l'avait employé pour ses caravanes avant de lui proposer le mariage. Elle fut la première croyante de l'islam.",
    culturalCapsule: { title: "Khadija — mère des croyants", text: "Le Prophète ﷺ disait : 'Elle a cru en moi quand les gens me reniaient, elle m'a soutenu de sa fortune quand les gens me privaient.' (Al-Bukhari). Il lui resta fidèle toute sa vie et continua de l'honorer après sa mort." },
  },
  {
    id: "sira_004", category: "sira", type: "mcq", difficulty: 1,
    arabicRequired: "none",
    question: "En quelle année a eu lieu la Hijra (migration vers Médine) ?",
    options: [
      { text: "610 ap. J.-C.", correct: false },
      { text: "615 ap. J.-C.", correct: false },
      { text: "622 ap. J.-C.", correct: true },
      { text: "630 ap. J.-C.", correct: false },
    ],
    explanation: "La Hijra eut lieu en 622 ap. J.-C. Elle marque le début du calendrier hégirien. Le Prophète ﷺ quitta La Mecque en compagnie d'Abu Bakr رضي الله عنه.",
  },
  {
    id: "sira_005", category: "sira", type: "mcq", difficulty: 2,
    arabicRequired: "none",
    question: "Dans quelle bataille les 313 musulmans affrontèrent-ils une armée de près de 1 000 Mecquois ?",
    options: [
      { text: "Uhud", correct: false },
      { text: "Khandaq", correct: false },
      { text: "Badr", correct: true },
      { text: "Khaybar", correct: false },
    ],
    explanation: "La bataille de Badr (624 ap. J.-C.) fut la première grande bataille de l'islam. Malgré leur infériorité numérique, les musulmans remportèrent une victoire décisive. Le Coran y fait référence en Sourate Al-Anfal (8:9-10).",
    culturalCapsule: { title: "Badr — la Journée du Critère", text: "Allah nomma Badr 'Yawm al-Furqan' (la Journée du Critère). 70 polythéistes furent tués, 70 capturés. Parmi les captifs, ceux qui pouvaient enseigner à lire furent libérés contre rançon — signe de la valeur accordée au savoir." },
  },
  {
    id: "sira_006", category: "sira", type: "mcq", difficulty: 2,
    arabicRequired: "none",
    question: "Combien d'années dura la période mecquoise de la mission prophétique ?",
    options: [
      { text: "7 ans", correct: false },
      { text: "10 ans", correct: false },
      { text: "13 ans", correct: true },
      { text: "23 ans", correct: false },
    ],
    explanation: "Le Prophète ﷺ prêcha à La Mecque pendant 13 ans (610-622 ap. J.-C.), puis à Médine pendant 10 ans. La mission prophétique totale dura 23 ans.",
  },
  {
    id: "sira_007", category: "sira", type: "mcq", difficulty: 2,
    arabicRequired: "none",
    question: "Quel compagnon accompagna le Prophète ﷺ lors de sa migration vers Médine ?",
    options: [
      { text: "Omar ibn al-Khattab رضي الله عنه", correct: false },
      { text: "Ali ibn Abi Talib رضي الله عنه", correct: false },
      { text: "Abu Bakr al-Siddiq رضي الله عنه", correct: true },
      { text: "Bilal ibn Rabah رضي الله عنه", correct: false },
    ],
    explanation: "Abu Bakr رضي الله عنه fut le seul compagnon à accompagner le Prophète ﷺ lors de la Hijra. Ils se cachèrent dans la grotte de Thawr pendant 3 jours avant de poursuivre vers Médine. (Coran 9:40)",
  },
  {
    id: "sira_008", category: "sira", type: "mcq", difficulty: 2,
    arabicRequired: "none",
    question: "À quel âge le Prophète ﷺ reçut-il la première révélation ?",
    options: [
      { text: "30 ans", correct: false },
      { text: "35 ans", correct: false },
      { text: "40 ans", correct: true },
      { text: "45 ans", correct: false },
    ],
    explanation: "Le Prophète ﷺ reçut la première révélation à 40 ans, dans la grotte de Hirâ, lors d'une nuit du mois de Ramadan. L'ange Jibril lui dit : 'Lis (Iqra) !' — premier mot révélé.",
    culturalCapsule: { title: "La nuit d'Iqra", text: "Le premier verset révélé fut : 'Lis, au nom de ton Seigneur qui a créé !' (Coran 96:1). Le Prophète ﷺ, illettré, répondit : 'Je ne sais pas lire.' Jibril le serra contre lui trois fois. Khadija رضي الله عنها fut la première à le réconforter et à croire en sa mission." },
  },
  {
    id: "sira_009", category: "sira", type: "mcq", difficulty: 2,
    arabicRequired: "none",
    question: "Comment s'appelle l'année de la naissance du Prophète ﷺ dans la tradition islamique ?",
    options: [
      { text: "L'Année du Feu", correct: false },
      { text: "L'Année de l'Éléphant", correct: true },
      { text: "L'Année de la Révélation", correct: false },
      { text: "L'Année du Déluge", correct: false },
    ],
    explanation: "Le Prophète ﷺ naquit vers 570 ap. J.-C., l'année où Abraha Al-Achram tenta de détruire la Kaaba avec des éléphants. Allah envoya des oiseaux (Ababil) pour les repousser. (Coran 105)",
  },
  {
    id: "sira_010", category: "sira", type: "mcq", difficulty: 2,
    arabicRequired: "none",
    question: "Dans quelle bataille une tranchée fut-elle creusée pour défendre Médine ?",
    options: [
      { text: "Badr", correct: false },
      { text: "Uhud", correct: false },
      { text: "Khandaq", correct: true },
      { text: "Tabuk", correct: false },
    ],
    explanation: "La bataille du Khandaq (la Tranchée) eut lieu en 627 ap. J.-C. Sur conseil de Salman Al-Farisi رضي الله عنه, le Prophète ﷺ fit creuser une tranchée autour de Médine. Cette stratégie (inconnue des Arabes) bloqua l'armée de 10 000 hommes.",
    culturalCapsule: { title: "Salman Al-Farisi — l'architecte de la victoire", text: "Salman était persan. Le Prophète ﷺ dit de lui : 'Salman fait partie de nous, de la Famille.' (Hadith authentifié). C'est lui qui proposa la stratégie de la tranchée, inspirée des tactiques militaires perses." },
  },
  {
    id: "sira_011", category: "sira", type: "mcq", difficulty: 3,
    arabicRequired: "none",
    question: "En quelle année eut lieu la libération (Fath) de La Mecque ?",
    options: [
      { text: "624 ap. J.-C.", correct: false },
      { text: "627 ap. J.-C.", correct: false },
      { text: "630 ap. J.-C.", correct: true },
      { text: "632 ap. J.-C.", correct: false },
    ],
    explanation: "Le Fath Makkah (libération de La Mecque) eut lieu en l'an 8 de l'Hégire / 630 ap. J.-C. Le Prophète ﷺ entra avec une armée de 10 000 hommes et proclama l'amnistie générale pour les Mecquois.",
    culturalCapsule: { title: "L'amnistie de La Mecque", text: "Alors que les Mecquois craignaient le pire, le Prophète ﷺ dit : 'Vous êtes libres. Allez, vous n'êtes pas responsables aujourd'hui.' Il détruisit les idoles de la Kaaba et récita Coran 17:81 : 'La vérité est venue, le mensonge a disparu.'" },
  },
  {
    id: "sira_012", category: "sira", type: "mcq", difficulty: 3,
    arabicRequired: "none",
    question: "Lors de la bataille d'Uhud, quel fut le résultat pour les musulmans ?",
    options: [
      { text: "Une victoire complète des musulmans", correct: false },
      { text: "Un match nul sans vainqueur clair", correct: false },
      { text: "Une défaite partielle due à la désobéissance des archers", correct: true },
      { text: "Une reddition des Mecquois", correct: false },
    ],
    explanation: "À Uhud (625 ap. J.-C.), les musulmans étaient en bonne position jusqu'à ce que des archers quittent leur poste contre l'ordre du Prophète ﷺ. Une contre-attaque de Khalid ibn Walid (encore polythéiste) provoqua un retournement. 70 compagnons furent martyrs, dont Hamza رضي الله عنه.",
  },
  {
    id: "sira_013", category: "sira", type: "mcq", difficulty: 3,
    arabicRequired: "none",
    question: "Quel compagnon fut surnommé 'l'épée d'Allah' (Sayf Allah) par le Prophète ﷺ ?",
    options: [
      { text: "Omar ibn al-Khattab رضي الله عنه", correct: false },
      { text: "Abu Ubaida ibn al-Jarrah رضي الله عنه", correct: false },
      { text: "Khalid ibn Walid رضي الله عنه", correct: true },
      { text: "Zubayr ibn al-Awwam رضي الله عنه", correct: false },
    ],
    explanation: "Khalid ibn Walid رضي الله عنه fut surnommé 'Sayf Allah al-Maslul' (l'épée tirée d'Allah) par le Prophète ﷺ après la bataille de Muta (629 ap. J.-C.). Il n'avait jamais perdu une bataille de toute sa carrière militaire.",
  },
  {
    id: "sira_014", category: "sira", type: "mcq", difficulty: 1,
    arabicRequired: "none",
    question: "Quel était le surnom affectueux du Prophète ﷺ donné par Aïcha رضي الله عنها ?",
    options: [
      { text: "Al-Amin (le digne de confiance)", correct: false },
      { text: "Abu al-Qasim", correct: false },
      { text: "Al-Habib (le bien-aimé)", correct: false },
      { text: "La tradition rapporte qu'elle l'appelait Abu al-Qasim ou par son nom", correct: true },
    ],
    explanation: "Le Prophète ﷺ portait plusieurs surnoms : Al-Amin (avant la révélation), Al-Habib, Al-Mustafa (l'Élu). Son nom complet est Muhammad ibn Abdallah. Son kunya était Abu al-Qasim, du nom de son fils aîné Al-Qasim.",
  },
  {
    id: "sira_015", category: "sira", type: "mcq", difficulty: 3,
    arabicRequired: "none",
    question: "Lors du Dernier Pèlerinage (Hajjat al-Wada), quel verset coranique fut révélé annonçant la perfection de la religion ?",
    options: [
      { text: "Sourate Al-Baqara 2:177", correct: false },
      { text: "Sourate Al-Maida 5:3", correct: true },
      { text: "Sourate Al-Anfal 8:2", correct: false },
      { text: "Sourate Al-Hujurat 49:13", correct: false },
    ],
    explanation: "Al-Maida 5:3 : 'Aujourd'hui, J'ai parachevé pour vous votre religion, accompli Sur vous Ma grâce et agréé l'islam comme religion pour vous.' Révélé lors du Dernier Pèlerinage (632 ap. J.-C.), 81 jours avant la mort du Prophète ﷺ.",
    culturalCapsule: { title: "Le Dernier Pèlerinage", text: "Lors du Khutbat al-Wada (sermon d'adieu), le Prophète ﷺ dit : 'J'ai laissé parmi vous deux choses ; si vous vous y accrochez, vous ne vous égarerez jamais : le Livre d'Allah et la Sunna de Son Prophète.' (Muwatta Malik)." },
  },

  // ── FIQH — Jurisprudence pratique ───────────────────────────────────
  {
    id: "fiqh_001", category: "fiqh", type: "mcq", difficulty: 1,
    arabicRequired: "none",
    question: "Combien de parties du corps sont lavées lors du wudu (ablutions) ?",
    options: [
      { text: "3 parties", correct: false },
      { text: "4 parties", correct: true },
      { text: "6 parties", correct: false },
      { text: "8 parties", correct: false },
    ],
    explanation: "Les 4 parties obligatoires (fard) du wudu sont : le visage, les bras jusqu'aux coudes, la tête (masah), et les pieds jusqu'aux chevilles. (Coran 5:6 — Sourate Al-Maida)",
  },
  {
    id: "fiqh_002", category: "fiqh", type: "mcq", difficulty: 2,
    arabicRequired: "none",
    question: "Lequel de ces actes brise le wudu ?",
    options: [
      { text: "Manger un repas", correct: false },
      { text: "Se laver les mains", correct: false },
      { text: "Dormir profondément allongé", correct: true },
      { text: "Parler pendant la prière", correct: false },
    ],
    explanation: "Le sommeil profond (nawm thaqil) brise le wudu car il supprime la conscience et peut entraîner une émission involontaire de gaz. Les quatre imams sont d'accord sur ce point, avec des nuances sur le sommeil léger assis.",
  },
  {
    id: "fiqh_003", category: "fiqh", type: "mcq", difficulty: 2,
    arabicRequired: "none",
    question: "Quel est le taux de la Zakat sur l'argent et l'or ?",
    options: [
    ...
    explanation: "Le taux de la Zakat sur l'argent, l'or et les actifs financiers est de 2,5 % (un quarantième) du montant total, à condition que ce montant atteigne le nisab (seuil minimum) et soit détenu depuis un an lunaire complet.",
  },
  {
    id: "fiqh_004", category: "fiqh", type: "mcq", difficulty: 2,
    arabicRequired: "none",
    question: "Quel terme désigne le seuil minimum de richesse à partir duquel la Zakat devient obligatoire ?",
    options: [
      { text: "Sadaqa", correct: false },
      { text: "Nisab", correct: true },
      { text: "Hawl", correct: false },
      { text: "Waqf", correct: false },
    ],
    explanation: "Le nisab est le seuil minimum. Pour l'argent et l'or, il correspond à la valeur de 85 grammes d'or ou 595 grammes d'argent. En dessous de ce seuil, la Zakat n'est pas due.",
  },
  {
    id: "fiqh_005", category: "fiqh", type: "mcq", difficulty: 2,
    arabicRequired: "none",
    question: "Lequel de ces actes annule le jeûne du Ramadan ?",
    options: [
      { text: "Faire l'injection d'un vaccin", correct: false },
      { text: "Se brosser les dents avec du dentifrice sans l'avaler", correct: false },
      { text: "Manger ou boire délibérément", correct: true },
      { text: "Saigner d'une blessure involontaire", correct: false },
    ],
    explanation: "Manger, boire ou avoir des rapports conjugaux délibérément pendant la journée de Ramadan annule le jeûne. Les actes involontaires (oubli) ou les injections (qui ne nourrissent pas) ne l'annulent pas selon la majorité des savants.",
  },
  {
    id: "fiqh_006", category: "fiqh", type: "mcq", difficulty: 2,
    arabicRequired: "none",
    question: "La Zakat est-elle due sur les bijoux d'or portés par une femme ?",
    options: [
      { text: "Oui, toujours et sans condition", correct: false },
      { text: "Non, jamais selon tous les savants", correct: false },
      { text: "Oui selon les Hanafites ; non selon les Shafi'ites et Malikites si usage personnel", correct: true },
      { text: "Uniquement si les bijoux dépassent 1 kg d'or", correct: false },
    ],
    explanation: "Il y a un désaccord entre les écoles : les Hanafites imposent la Zakat sur les bijoux d'usage. Les Malikites et Shafi'ites en exemptent les bijoux portés à usage personnel (dans la limite du raisonnable). Les Hanbalites ont deux positions.",
  },
  {
    id: "fiqh_007", category: "fiqh", type: "mcq", difficulty: 1,
    arabicRequired: "none",
    question: "Combien de fois par an la Zakat est-elle due ?",
    options: [
      { text: "Chaque mois", correct: false },
      { text: "Chaque semaine", correct: false },
      { text: "Une fois par an lunaire (Hawl)", correct: true },
      { text: "Seulement pendant le Ramadan", correct: false },
    ],
    explanation: "La Zakat est due une fois par an lunaire (Hawl). La richesse doit avoir été détenue en continu au-dessus du nisab pendant une année lunaire complète pour que la Zakat s'applique.",
  },
  {
    id: "fiqh_008", category: "fiqh", type: "mcq", difficulty: 3,
    arabicRequired: "none",
    question: "Lequel de ces actes est un pilier (rukn) obligatoire du wudu selon tous les imams ?",
    options: [
      { text: "Se rincer la bouche (madhma'a)", correct: false },
      { text: "Se rincer le nez (istinchaq)", correct: false },
      { text: "Laver le visage entier", correct: true },
      { text: "Frotter (dalk) les membres lavés", correct: false },
    ],
    explanation: "Le lavage du visage est un pilier (fard) du wudu selon tous les quatre imams. Se rincer la bouche et le nez sont Sunnah confirmée (wajib chez les Hanafites). Le frottage (dalk) est obligatoire uniquement chez les Malikites.",
  },
  {
    id: "fiqh_009", category: "fiqh", type: "mcq", difficulty: 2,
    arabicRequired: "none",
    question: "Qu'est-ce que la Zakat al-Fitr ?",
    options: [
      { text: "La Zakat annuelle sur l'épargne", correct: false },
      { text: "Une aumône obligatoire versée à la fin du Ramadan avant la prière de l'Aïd", correct: true },
      { text: "Une donation volontaire pendant le Hajj", correct: false },
      { text: "La taxe sur les revenus du commerce", correct: false },
    ],
    explanation: "La Zakat al-Fitr est obligatoire pour tout musulman qui en a les moyens. Elle équivaut environ à 2,5 kg de nourriture de base (riz, blé, dattes) par personne. Elle doit être versée avant la prière de l'Aïd al-Fitr. (Hadith de Ibn Omar, Al-Bukhari)",
  },
  {
    id: "fiqh_010", category: "fiqh", type: "mcq", difficulty: 3,
    arabicRequired: "none",
    question: "Quelle est la condition principale pour que la prière soit valide ?",
    options: [
      { text: "Être en état de wudu", correct: false },
      { text: "Faire face à la Qibla", correct: false },
      { text: "Avoir l'intention (niyya)", correct: false },
      { text: "Toutes ces conditions sont obligatoires simultanément", correct: true },
    ],
    explanation: "La prière requiert plusieurs conditions (shuroot) : la purification rituelle (tahara), l'habillement des 'awra, faire face à la Qibla, avoir l'intention (niyya) et entrer dans le temps de la prière. L'absence de l'une d'elles invalide la prière.",
  },
  {
    id: "fiqh_011", category: "fiqh", type: "mcq", difficulty: 2,
    arabicRequired: "none",
    question: "Quel est le sens du mot 'Halal' en arabe ?",
    options: [
      { text: "Pur (tahir)", correct: false },
      { text: "Permis / licite", correct: true },
      { text: "Béni (mubarak)", correct: false },
      { text: "Obligatoire (wajib)", correct: false },
    ],
    explanation: "Halal (حلال) signifie 'permis' ou 'licite'. L'opposé est Haram (interdit). Entre les deux : Makruh (déconseillé), Mubah (neutre), Mandub (recommandé). Ces cinq catégories forment l'échelle des jugements juridiques islamiques (ahkam).",
  },
  {
    id: "fiqh_012", category: "fiqh", type: "mcq", difficulty: 3,
    arabicRequired: "none",
    question: "Qu'est-ce que le Tayammum ?",
    options: [
      { text: "La prière de nuit volontaire", correct: false },
      { text: "La purification sèche avec de la terre pure en l'absence d'eau", correct: true },
      { text: "Le jeûne volontaire en dehors du Ramadan", correct: false },
      { text: "La récitation du Coran après la prière", correct: false },
    ],
    explanation: "Le Tayammum est la purification rituelle avec de la terre pure (sol, sable, pierre) lorsqu'on n'a pas d'eau ou qu'on ne peut pas l'utiliser (maladie, danger). Il remplace le wudu et le ghusl. (Coran 4:43 ; 5:6)",
  },
  {
    id: "fiqh_013", category: "fiqh", type: "mcq", difficulty: 2,
    arabicRequired: "none",
    question: "Lequel de ces aliments est clairement interdit (haram) dans le Coran ?",
    options: [
      { text: "Le poulet non-égorgé selon les règles islamiques", correct: false },
      { text: "La viande de porc", correct: true },
      { text: "Les légumineuses (lentilles, pois chiches)", correct: false },
      { text: "Les fruits de mer en général", correct: false },
    ],
    explanation: "Le Coran interdit explicitement : la viande de porc, le sang, la charogne et ce qui a été sacrifié à d'autres qu'Allah. (Coran 2:173 ; 5:3 ; 6:145 ; 16:115). Les fruits de mer sont permis selon la majorité des savants.",
  },
  {
    id: "fiqh_014", category: "fiqh", type: "mcq", difficulty: 1,
    arabicRequired: "none",
    question: "Combien de prières quotidiennes sont obligatoires (fard) pour tout musulman ?",
    options: [
      { text: "3 prières", correct: false },
      { text: "4 prières", correct: false },
      { text: "5 prières", correct: true },
      { text: "7 prières", correct: false },
    ],
    explanation: "Les 5 prières obligatoires sont : Fajr (aube), Dhuhr (midi), Asr (après-midi), Maghrib (coucher du soleil) et Isha (nuit). Elles furent imposées lors du voyage nocturne (Isra wal-Miraj) : initialement 50, réduites à 5 après intercession du Prophète ﷺ.",
  },
  {
    id: "fiqh_015", category: "fiqh", type: "mcq", difficulty: 3,
    arabicRequired: "none",
    question: "Quelle est la différence entre 'Fard' et 'Wajib' dans le fiqh hanafite ?",
    options: [
      { text: "Ce sont deux termes identiques sans différence", correct: false },
      { text: "Fard est établi par le Coran ; Wajib par une preuve moins certaine (hadith ahad)", correct: true },
      { text: "Fard est plus léger que Wajib en termes d'obligation", correct: false },
      { text: "Wajib est spécifique au Hajj ; Fard s'applique à toute la religion", correct: false },
    ],
    explanation: "Selon l'école Hanafite : Fard est établi par une preuve certaine (Coran, hadith mutawatir) — nier un fard est de la mécréance. Wajib est établi par une preuve probable (hadith ahad) — omettre un wajib délibérément est un grand péché mais n'atteint pas la mécréance. Les autres écoles n'opèrent pas cette distinction.",
  },

  // ── THÉOLOGIE — Asma al-Husna (Les 99 noms d'Allah) ─────────────────
  {
    id: "asma_001", category: "theologie", type: "mcq", difficulty: 1,
    arabicRequired: "beginner",
    question: "Que signifie le nom divin Ar-Rahman (الرَّحْمَن) ?",
    options: [
      { text: "Le Tout-Puissant", correct: false },
      { text: "Le Tout Miséricordieux — grâce universelle s'étendant à tous", correct: true },
      { text: "Le Créateur", correct: false },
      { text: "Le Très Grand", correct: false },
    ],
    explanation: "Ar-Rahman désigne la miséricorde divine universelle qui englobe toutes les créatures, croyants et non-croyants. C'est l'un des deux noms cités dans la Basmala. Il est mentionné 57 fois dans le Coran.",
    culturalCapsule: { title: "Ar-Rahman — une miséricorde sans condition", text: "Les savants distinguent : Ar-Rahman = miséricorde générale pour tous en ce monde. Ar-Rahim = miséricorde spéciale réservée aux croyants au Jour dernier. Ensemble, ils encadrent la Basmala que tout musulman récite avant chaque acte important." },
  },
  {
    id: "asma_002", category: "theologie", type: "mcq", difficulty: 1,
    arabicRequired: "beginner",
    question: "Que signifie le nom divin Al-Malik (الْمَلِك) ?",
    options: [
      { text: "Le Roi / le Souverain absolu", correct: true },
      { text: "Le Sage", correct: false },
      { text: "Le Vivant", correct: false },
      { text: "Le Généreux", correct: false },
    ],
    explanation: "Al-Malik (le Roi) désigne la souveraineté absolue d'Allah sur tout l'univers. Mentionné dans Al-Fatiha (1:4) : 'Maître du Jour du Jugement (Maliki yawm id-din)'. Il est aussi l'un des noms cités dans la Sourate Al-Hashr (59:23).",
  },
  {
    id: "asma_003", category: "theologie", type: "mcq", difficulty: 1,
    arabicRequired: "beginner",
    question: "Que signifie le nom divin As-Salam (السَّلَام) ?",
    options: [
      { text: "Le Pardonneur", correct: false },
      { text: "Celui qui accorde la paix et est exempt de tout défaut", correct: true },
      { text: "Le Protecteur", correct: false },
      { text: "L'Unique", correct: false },
    ],
    explanation: "As-Salam signifie que Allah est exempté de tout défaut, toute imperfection et toute fin. Il est aussi la source de la paix pour Ses croyants. Mentionné dans Sourate Al-Hashr (59:23). Le Salâm islamique (Assalamu Alaikum) s'inspire de ce nom.",
  },
  {
    id: "asma_004", category: "theologie", type: "mcq", difficulty: 2,
    arabicRequired: "beginner",
    question: "Que signifie le nom divin Al-Aziz (الْعَزِيز) ?",
    options: [
      { text: "Le Très Grand", correct: false },
      { text: "Le Tout-Puissant / l'Inaccessible", correct: true },
      { text: "Le Savant", correct: false },
      { text: "Le Miséricordieux", correct: false },
    ],
    explanation: "Al-Aziz désigne la puissance souveraine et l'inaccessibilité divine — personne ne peut Le contraindre. Dans la tradition islamique, Al-Aziz peut aussi être un titre d'honneur humain (le Prophète Yusuf ﷺ était appelé ainsi par le roi d'Égypte). Il apparaît 92 fois dans le Coran.",
  },
  {
    id: "asma_005", category: "theologie", type: "mcq", difficulty: 2,
    arabicRequired: "beginner",
    question: "Que signifie le nom divin Al-Ghaffar (الْغَفَّار) ?",
    options: [
      { text: "Celui qui donne infiniment", correct: false },
      { text: "Le Très Pardonnant — qui efface les péchés à répétition", correct: true },
      { text: "Celui qui entend tout", correct: false },
      { text: "Le Très Doux", correct: false },
    ],
    explanation: "Al-Ghaffar (forme intensive de Ghafir) désigne le pardon répété et infini d'Allah. Al-Ghafur pardonne les grandes fautes ; Al-Ghaffar pardonne encore et encore malgré la récidive. 'Demande pardon à ton Seigneur, Il est le Très Pardonnant (Al-Ghaffar).' (Coran 71:10)",
  },
  {
    id: "asma_006", category: "theologie", type: "mcq", difficulty: 2,
    arabicRequired: "beginner",
    question: "Que signifie le nom divin Al-Khaliq (الْخَالِق) ?",
    options: [
      { text: "Le Soutien / Celui qui subvient", correct: false },
      { text: "Le Créateur de toutes choses à partir du néant", correct: true },
      { text: "Celui qui ressuscite les morts", correct: false },
      { text: "Le Très Sage", correct: false },
    ],
    explanation: "Al-Khaliq est le Créateur absolu. Dans le Coran, seul Allah est qualifié de Khaliq au sens plein — créer à partir du néant (khalq min al-adam). Les êtres humains peuvent 'créer' des choses, mais à partir de matière existante. (Coran 59:24 ; 35:3)",
  },
  {
    id: "asma_007", category: "theologie", type: "mcq", difficulty: 2,
    arabicRequired: "beginner",
    question: "Que signifie le nom divin Al-Wahhab (الْوَهَّاب) ?",
    options: [
      { text: "Le Maître de la mort", correct: false },
      { text: "Celui qui octroie des bienfaits sans contrepartie", correct: true },
      { text: "Celui qui entend les prières", correct: false },
      { text: "Le Très Proche de Ses serviteurs", correct: false },
    ],
    explanation: "Al-Wahhab désigne le don généreux sans attente de retour. 'Ou bien possèdent-ils les trésors de la grâce de ton Seigneur, le Tout-Puissant, le Grand Donateur (Al-Wahhab) ?' (Coran 38:9). Cette grâce est sans mérite de la part du bénéficiaire.",
  },
  {
    id: "asma_008", category: "theologie", type: "mcq", difficulty: 2,
    arabicRequired: "beginner",
    question: "Que signifie le nom divin Al-Basir (الْبَصِير) ?",
    options: [
      { text: "Le Tout Savant (des secrets)", correct: false },
      { text: "Le Tout Voyant — qui voit toute chose", correct: true },
      { text: "Celui qui entend tout", correct: false },
      { text: "Le Très Attentif à Ses serviteurs", correct: false },
    ],
    explanation: "Al-Basir désigne la vision divine totale — Allah voit ce qui est visible comme ce qui est caché, l'infiniment petit comme l'infiniment grand. Souvent couplé à As-Sami' (le Tout Entendant) dans le Coran : 'Il est le Tout Entendant, le Tout Voyant.' (Coran 42:11)",
  },
  {
    id: "asma_009", category: "theologie", type: "mcq", difficulty: 3,
    arabicRequired: "beginner",
    question: "Que signifie le nom divin Al-Hayy al-Qayyum (الْحَيُّ الْقَيُّوم) ?",
    options: [
      { text: "Le Seigneur du Ciel et de la Terre", correct: false },
      { text: "Le Vivant qui Se suffit à Lui-même et dont tout dépend", correct: true },
      { text: "Le Premier et le Dernier", correct: false },
      { text: "L'Omniscient, le Très Sage", correct: false },
    ],
    explanation: "Al-Hayy al-Qayyum sont deux noms liés dans l'Ayat al-Kursi (Coran 2:255) — le verset le plus grand du Coran. Al-Hayy = le Vivant éternel. Al-Qayyum = Celui qui Se suffit à Lui-même et dont toutes les créatures dépendent. Ces deux noms forment ensemble Al-Ism al-A'zam selon plusieurs savants.",
    culturalCapsule: { title: "Ayat al-Kursi — le verset du Trône", text: "Le Prophète ﷺ a dit : 'La sourate la plus grande du Coran est Ayat al-Kursi.' (Muslim). Lire ce verset le soir protège jusqu'au lendemain matin. Il contient Al-Hayy al-Qayyum, As-Sami', Al-Alim et d'autres noms divins." },
  },
  {
    id: "asma_010", category: "theologie", type: "mcq", difficulty: 1,
    arabicRequired: "beginner",
    question: "Combien y a-t-il de noms d'Allah (Asma al-Husna) selon le hadith du Prophète ﷺ ?",
    options: [
      { text: "33 noms", correct: false },
      { text: "66 noms", correct: false },
      { text: "99 noms", correct: true },
      { text: "114 noms", correct: false },
    ],
    explanation: "Le Prophète ﷺ a dit : 'Allah a 99 noms. Celui qui les dénombre (les compte et les médite) entrera au Paradis.' (Al-Bukhari et Muslim). Les savants précisent que 'les dénombrer' signifie les connaître, les comprendre et les invoquer dans ses duaa.",
  },
];
